...
def CreateProcess(appName:'str',commandLine:'str',processAttributes:'PySECURITY_ATTRIBUTES',threadAttributes:'PySECURITY_ATTRIBUTES',bInheritHandles:'int',dwCreationFlags:'int',newEnvironment:'Union[Any, None]',currentDirectory:'str',startupinfo:'PySTARTUPINFO') -> 'Tuple[int, int, int, int]':
    """
...
Args:
      ...
      newEnvironment(Union[Any, None]):A dictionary of string or Unicode pairs to define the environment for the process, or None to inherit the current environment.
