...
def InternetCloseHandle(handle:typing.Any) -> None:
    """
    None
...
Args:
      ...
      handle(typing.Any):CommentsIt should not be necessary to call this function - all handles are PyHINTERNET objects, so can have their Close method called, and will otherwise be automatically closed.
...
def InternetConnect(Internet:typing.Any,ServerName:str,ServerPort:int,Username:str,Password:str,Service:int,Flags:int,Context:typing.Any=None) -> None:
    """
...
Args:
      ...
      Internet(typing.Any):Valid HINTERNET handle returned by a previous call to win32inet::InternetOpen.
...
def InternetOpenUrl(Internet:typing.Any,Url:str,Headers:str=None,Flags:int=0,Context:typing.Any=None) -> typing.Any:
    """
...
Args:
      ...
      Internet(typing.Any):Internet handle as returned by win32inet::InternetOpen
...
Returns:
      ...
      typing.Any:An arbitrary object to be passed to the status callback function
Comments
...
def InternetReadFile(hInternet:typing.Any,size:int) -> str:
    """
    None
...
def InternetWriteFile(File:typing.Any,Buffer:str) -> int:
    """
    None
...
Args:
      ...
      File(typing.Any):Writeable internet	handle
...
def FtpOpenFile(hConnect:typing.Any,FileName:str,Access:int,Flags:int,Context:typing.Any=None) -> typing.Any:
    """
...
Args:
      ...
      hConnect(typing.Any):Valid HINTERNET handle to an FTP session.
...
def FtpCommand(Connect:typing.Any,ExpectResponse:bool,Flags:int,Command:str,Context:typing.Any=None) -> typing.Any:
    """
...
Args:
      ...
      Connect(typing.Any):Valid HINTERNET	handle to an FTP session.
...
def InternetQueryOption(hInternet:typing.Any,Option:int) -> typing.Any:
    """
...
Args:
      ...
      hInternet(typing.Any):Internet handle, or None for global defaults
...
def InternetSetOption(hInternet:typing.Any,Option:int,Buffer:typing.Any) -> None:
    """
...
def FindFirstUrlCacheEntry(SearchPattern:str=None) -> typing.Any:
    """
...
Returns:
      ...
      typing.Any:Search for FindFirstUrlCacheEntry at msdn, google or google groups.
...
def FindNextUrlCacheEntry(EnumHandle:typing.Any) -> dict:
    """
...
Args:
      ...
      EnumHandle(typing.Any):Cache enumeration handle as returned by win32inet::FindFirstUrlCacheEntryCommentsAccepts keyword argsWin32 API References
...
def FindFirstUrlCacheEntryEx(SearchPattern:str=None,Flags:int=0,Filter:int=0,GroupId:int=0) -> typing.Any:
    """
    Initiates an enumeration of the browser cache
...
Returns:
      ...
      typing.Any:Search for FindFirstUrlCacheEntryEx at msdn, google or google groups.
Return ValueReturns a handle that can be passed to win32inet::FindNextUrlCacheEntry, and a dict 
...
def FindNextUrlCacheEntryEx(EnumHandle:typing.Any) -> dict:
    """
    Continues enumeration of cached files
...
Args:
      ...
      EnumHandle(typing.Any):Cache enumeration handle as returned by win32inet::FindFirstUrlCacheEntryExCommentsAccepts keyword argsWin32 API References
...
def FindCloseUrlCache(EnumHandle:typing.Any) -> None:
    """
...
def FindFirstUrlCacheGroup(Filter:int) -> typing.Any:
    """
...
Returns:
      ...
      typing.Any:Search for FindFirstUrlCacheGroup at msdn, google or google groups.
...
def FindNextUrlCacheGroup(Find:typing.Any) -> int:
    """
...
Args:
      ...
      Find(typing.Any):Group enumeration handle as returned by win32inet::FindFirstUrlCacheGroupCommentsAccepts keyword argsWin32 API References
...
def CreateUrlCacheGroup(Flags:int=0) -> typing.Any:
    """
...
def CommitUrlCacheEntry(UrlName:str,LocalFileName:str,CacheEntryType:int,ExpireTime:typing.Any=None,LastModifiedTime:typing.Any=None,HeaderInfo:str=None,OriginalUrl:str=None) -> str:
    """
...
Args:
      ...
      ExpireTime(typing.Any):Time at which entry expires
      LastModifiedTime(typing.Any):Modification time of URL
