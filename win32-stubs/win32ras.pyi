...
def Dial(dialExtensions:typing.Any,fileName:str,RasDialParams:typing.Any,callback:typing.Any) -> typing.Any:
    """
...
Returns:
      ...
      typing.Any:Search for RasDial at msdn, google or google groups.
...
def GetConnectStatus(hrasconn:int) -> typing.Any:
    """
...
def GetEntryDialParams(fileName:str,entryName:str) -> typing.Any:
    """
...
Returns:
      ...
      typing.Any:Search for RasGetConnectStatus at msdn, google or google groups.
...
def SetEntryDialParams(fileName:str,RasDialParams:typing.Any,bSavePassword:int) -> None:
    """
