...
class NCB(object):
      ...
      @property
      def Lana_num(self)->'int':
         """"""
         pass


      @property
      def Cmd_cplt(self)->'int':
         """"""
         pass
...
Returns:
      ...
      def AddAccessAllowedAce(self,revision:'int',access:'int',sid:'PySID',access1:'Any',sid1:'Any') -> 'None':
         """
...
Args:
      ...
      revision(int):Pre-win2k, must be ACL_REVISION, otherwise also may be ACL_REVISION_DS.
      access(int):Specifies the mask of access rights to be denied to the specified SID.
...
Args:
      ...
      revision(int):Must be at least ACL_REVISION_DS
      aceflags(int):Combination of ACE inheritance flags (CONTAINER_INHERIT_ACE,INHERIT_ONLY_ACE,INHERITED_ACE,NO_PROPAGATE_INHERIT_ACE, and OBJECT_INHERIT_ACE)
      access(int):Specifies the mask of access rights to be granted to the specified SID.
...
Returns:
      ...
      def AddAccessAllowedObjectAce(self,AceRevision:'int',AceFlags:'int',AccessMask:'int',ObjectTypeGuid:'PyIID',InheritedObjectTypeGuid:'PyIID',sid:'PySID') -> 'None':
         """
         Adds an ACCESS_ALLOWED_OBJECT_ACE to the ACL

Args:

      AceRevision(int):Must be at least ACL_REVISION_DS
      AceFlags(int):Combination of ACE inheritance flags (CONTAINER_INHERIT_ACE,INHERIT_ONLY_ACE,INHERITED_ACE,NO_PROPAGATE_INHERIT_ACE, and OBJECT_INHERIT_ACE)
...
Returns:
      ...
      def AddAccessDeniedAce(self,revision:'int',access:'int',sid:'PySID',access1:'Any',sid1:'Any') -> 'None':
         """
...
Returns:
      ...
      def AddMandatoryAce(self,AceRevision:'int',AceFlags:'int',MandatoryPolicy:'int',LabelSid:'PySID') -> 'None':
         """
         Adds a mandatory integrity level ACE to a SACL

Args:

      AceRevision(int):ACL_REVISION or ACL_REVISION_DS
      AceFlags(int):Combination of ACE inheritance flags (CONTAINER_INHERIT_ACE,INHERIT_ONLY_ACE,INHERITED_ACE,NO_PROPAGATE_INHERIT_ACE, and OBJECT_INHERIT_ACE)
      MandatoryPolicy(int):Access policy for processes with lower integrity level, combination of SYSTEM_MANDATORY_LABEL_* flags
...
Returns:
      ...
      def AddAuditAccessAce(self,dwAceRevision:'int',dwAccessMask:'int',sid:'PySID',bAuditSuccess:'int',bAuditFailure:'int') -> 'None':
         """
         Adds an audit ACE to a Sacl

Args:

      dwAceRevision(int):Revision of ACL: Pre-Win2k, must be ACL_REVISION. Win2K on up, can also be ACL_REVISION_DS
      dwAccessMask(int):Bitmask of access types to be audited
      sid(PySID):SID for whom system audit messages will be generated
      bAuditSuccess(int):Set to 1 if access success should be audited, else 0
      bAuditFailure(int):Set to 1 if access failure should be audited, else 0
...
Returns:
      ...
      def AddAuditAccessAceEx(self,dwAceRevision:'int',AceFlags:'int',dwAccessMask:'int',sid:'PySID',bAuditSuccess:'int',bAuditFailure:'int') -> 'None':
         """
         Adds an audit ACE to an Sacl, includes ace flags

Args:

      dwAceRevision(int):Revision of ACL: Must be at least ACL_REVISION_DS
      AceFlags(int):Combination of FAILED_ACCESS_ACE_FLAG,SUCCESSFUL_ACCESS_ACE_FLAG,CONTAINER_INHERIT_ACE,INHERIT_ONLY_ACE,INHERITED_ACE,NO_PROPAGATE_INHERIT_ACE and OBJECT_INHERIT_ACE
      dwAccessMask(int):Bitmask of access types to be audited
      sid(PySID):SID for whom system audit messages will be generated
      bAuditSuccess(int):Set to 1 if access success should be audited, else 0
      bAuditFailure(int):Set to 1 if access failure should be audited, else 0
...
Returns:
      ...
      def AddAuditAccessObjectAce(self,dwAceRevision:'int',AceFlags:'int',dwAccessMask:'int',ObjectTypeGuid:'PyIID',InheritedObjectTypeGuid:'PyIID',sid:'PySID',bAuditSuccess:'int',bAuditFailure:'int') -> 'None':
         """
...
Args:
      ...
      index(int):Zero-based index of the ACE to delete.
...
class PyCERTSTORE(object):
      ...
      @property
      def HCERTSTORE(self)->'int':
         """Integer handle"""
         pass


      def CertCloseStore(self,Flags:'int'=0) -> 'None':
         """
         Closes the certificate store

Args:

      Flags(int):Combination of CERT_CLOSE_*_FLAG flags
...
Returns:
      ...
      def CertControlStore(self,Flags:'int',CtrlType:'int',CtrlPara:'int') -> 'None':
         """
         Controls sychronization of the certificate store

Args:

      Flags(int):One of the CERT_STORE_CTRL_*_FLAG flags
      CtrlType(int):One of the CERT_STORE_CTRL_* flags
...
Returns:
      ...
      def CertAddEncodedCertificateToStore(self,CertEncodingType:'int',CertEncoded:'Any',AddDisposition:'int') -> 'PyCERT_CONTEXT':
         """
...
Args:
      ...
      CertEncodingType(int):Usually X509_ASN_ENCODING combined with PKCS_7_ASN_ENCODING
      CertEncoded(Any):Data containing a serialized certificate
      AddDisposition(int):Combination of CERT_STORE_ADD_* flags
...
Returns:
      ...
      def CertAddCertificateContextToStore(self,CertContext:'PyCERT_CONTEXT',AddDisposition:'int') -> 'PyCERT_CONTEXT':
         """
...
Args:
      ...
      AddDisposition(int):CERT_STORE_ADD_* constant
...
Returns:
      ...
      def CertAddCertificateLinkToStore(self,CertContext:'PyCERT_CONTEXT',AddDisposition:'int') -> 'PyCERT_CONTEXT':
         """
...
Args:
      ...
      AddDisposition(int):One of the CERT_STORE_ADD_* values
...
Returns:
      ...
      def CertAddCTLContextToStore(self,CtlContext:'PyCTL_CONTEXT',AddDisposition:'int') -> 'PyCTL_CONTEXT':
         """
...
Returns:
      ...
      def CertAddCTLLinkToStore(self,CtlContext:'PyCTL_CONTEXT',AddDisposition:'int') -> 'PyCTL_CONTEXT':
         """
...
Returns:
      ...
      def CertAddStoreToCollection(self,SiblingStore:'PyCERTSTORE',UpdateFlag:'int'=0,Priority:'int'=0) -> 'None':
         """
...
Args:
      ...
      UpdateFlag(int):Can be CERT_PHYSICAL_STORE_ADD_ENABLE_FLAG to enable changes to persist
      Priority(int):Determines order in which store are searched and updatedCommentsA collection store is created by using cryptoapi::CertOpenStore with CERT_STORE_PROV_COLLECTION
...
Returns:
      ...
      def PFXExportCertStoreEx(self,Flags:'int',Password:'str'=None) -> 'bytes':
         """
         Exports certificates and associated private keys in PKCS#12 format

Args:

      Flags(int):Options to be used while exporting
      Password(str):Passphrase to be used to encrypt the output
...
class PyCERT_BASIC_CONSTRAINTS_INFO(object):
      ...
      @property
      def SubtreesConstraint(self)->'tuple':
...
class PyCERT_CONTEXT(object):
      ...
      @property
      def CertEncoded(self)->'str':
         """Content of the certificate as encoded bytes"""
         pass


      @property
      def CertEncodingType(self)->'int':
...
Returns:
      ...
      def CertEnumCertificateContextProperties(self,) -> 'List[int]':
         """
...
Returns:
      ...
      def CryptAcquireCertificatePrivateKey(self,Flags:'int'=0) -> 'Tuple[int, PyCRYPTPROV]':
         """
...
Args:
      ...
      Flags(int):Combination of CRYPT_ACQUIRE_*_FLAG constantsCommentsOnly the owner of the certificate can use this methodReturn ValueReturns the KeySpec (AT_KEYEXCHANGE or AT_SIGNATURE) and a CSP handle to the key

Returns:

      Tuple[int, PyCRYPTPROV]:Combination of CRYPT_ACQUIRE_*_FLAG constants
Comments
...
Return ValueReturns the KeySpec (AT_KEYEXCHANGE or AT_SIGNATURE) and a CSP handle to the key
      ...
      def CertGetIntendedKeyUsage(self,) -> 'int':
         """
...
Returns:
      ...
      int:PyCERT_CONTEXT.CertGetIntendedKeyUsage
...
Return ValueReturns a combination of CERT_*_KEY_USAGE values
      ...
      def CertGetEnhancedKeyUsage(self,Flags:'int'=0) -> 'tuple':
         """
...
Args:
      ...
      Flags(int):CERT_FIND_EXT_ONLY_ENHKEY_USAGE_FLAG, CERT_FIND_PROP_ONLY_ENHKEY_USAGE_FLAG, or 0Return ValueReturns a sequence of usage OIDs

Returns:

      tuple:CERT_FIND_EXT_ONLY_ENHKEY_USAGE_FLAG, 
...
Return ValueReturns a sequence of usage OIDs
      ...
      def CertSerializeCertificateStoreElement(self,Flags:'int'=0) -> 'str':
         """
         Serializes the certificate and its properties

Args:

      Flags(int):Reserved, use only 0 if passed in
...
Returns:
      ...
      def CertVerifySubjectCertificateContext(self,Issuer:'PyCERT_CONTEXT',Flags:'int') -> 'int':
         """
...
Args:
      ...
      Flags(int):Combination of CERT_STORE_REVOCATION_FLAG,CERT_STORE_SIGNATURE_FLAG and CERT_STORE_TIME_VALIDITY_FLAG indicating which checks should be performedReturn ValueReturns flags indicating which validity checks failed, or 0 if all were successful.

Returns:

      int:Combination of CERT_STORE_REVOCATION_FLAG,CERT_STORE_SIGNATURE_FLAG and 
...
Returns:
      ...
      def CertGetCertificateContextProperty(self,PropId:'int') -> 'Any':
         """
...
class PyCERT_KEY_ATTRIBUTES_INFO(object):
      ...
      @property
      def PrivateKeyUsagePeriod(self)->'dict':
...
class PyCERT_POLICY_INFO(object):
      ...
      @property
      def PolicyIdentifier(self)->'str':
         """OID identifying the policy"""
         pass


      @property
      def PolicyQualifier(self)->'tuple':
...
Returns:
      ...
      def CryptDuplicateHash(self,Flags:'int'=0) -> 'PyCRYPTHASH':
         """
         Clones the hash object

Args:

      Flags(int):Reserved, use 0 if passed
...
Returns:
      ...
      def CryptHashData(self,Data:'str',Flags:'int'=0) -> 'None':
         """
...
Args:
      ...
      Flags(int):CRYPT_USERDATA or 0CommentsIf Flags is CRYPT_USERDATA, provider is expected to prompt user to enter data.  MSDN says that MS CSPs ignore this flag
...
Returns:
      ...
      def CryptHashSessionKey(self,Key:'PyCRYPTKEY',Flags:'int'=0) -> 'None':
         """
...
Args:
      ...
      Flags(int):CRYPT_LITTLE_ENDIAN or 0
...
Returns:
      ...
      def CryptSignHash(self,KeySpec:'int',Flags:'int'=0) -> 'str':
         """
         Signs the hash

Args:

      KeySpec(int):The key to be used to sign the hash, AT_KEYEXCHANGE,AT_SIGNATURE
      Flags(int):CRYPT_NOHASHOID,CRYPT_X931_FORMAT or 0CommentsThis methods signs only the hash, not the data that the hash represents
...
Returns:
      ...
      def CryptVerifySignature(self,Signature:'str',PubKey:'PyCRYPTKEY',Flags:'int'=0) -> 'None':
         """
...
Args:
      ...
      Flags(int):CRYPT_NOHASHOID,CRYPT_X931_FORMAT or 0
...
Args:
      ...
      Param(int):The parameter to retrieve: HP_ALGID, HP_HASHSIZE, or HP_HASHVAL
      Flags(int):Reserved, use 0 if passed inCommentsAfter this method has been called, no more data can be hashedReturn ValueType of returned object is dependent on the Param passed in
...
class PyCRYPTKEY(object):
      ...
      @property
      def HCRYPTPROV(self)->'int':
         """CSP used by the key"""
         pass


      @property
      def HCRYPTKEY(self)->'int':
...
Returns:
      ...
      def CryptExportKey(self,ExpKey:'PyCRYPTKEY',BlobType:'int',Flags:'int'=0) -> 'str':
         """
...
Args:
      ...
      BlobType(int):One of OPAQUEKEYBLOB,PRIVATEKEYBLOB,PUBLICKEYBLOB,SIMPLEBLOB,PLAINTEXTKEYBLOB,SYMMETRICWRAPKEYBLOB
      Flags(int):Combination of CRYPT_DESTROYKEY,CRYPT_SSL2_FALLBACK,CRYPT_OAEP or 0Return ValueReturns a binary blob that can be imported via PyCRYPTPROV::CryptImportKey

Returns:

      str:Combination of CRYPT_DESTROYKEY,CRYPT_SSL2_FALLBACK,CRYPT_OAEP or 0
Return ValueReturns a binary blob that can be imported via PyCRYPTPROV::CryptImportKey
      ...
      def CryptGetKeyParam(self,Param:'int',Flags:'int'=0) -> 'Any':
         """
         Retrieves key parameters

Args:

      Param(int):One of the KP_* constants
      Flags(int):Reserved, use only 0Return ValueType of returned object is dependent on the requested attribute
...
Return ValueType of returned object is dependent on the requested attribute
      ...
      def CryptDuplicateKey(self,Reserved:'int'=0,Flags:'int'=0) -> 'PyCRYPTKEY':
         """
         Creates an independent copy of the key

Args:

      Reserved(int):Use 0 if passed in
      Flags(int):Also reserved, use 0
...
Returns:
      ...
      def CryptEncrypt(self,Final:'int',Data:'Any',Hash:'PyCRYPTHASH'=None,Flags:'int'=0) -> 'str':
         """
         Encrypts and optionally hashes data

Args:

      Final(int):Boolean, use True if this is final encryption operation
      Data(Any):Data to be encrypted
      Hash(PyCRYPTHASH):Hash to be updated with data passed in, can be None
      Flags(int):Reserved, use 0 if passed in
...
Returns:
      ...
      def CryptDecrypt(self,Final:'int',Data:'Any',Hash:'PyCRYPTHASH'=None,Flags:'int'=0) -> 'str':
         """
         Decrypts data

Args:

      Final(int):Boolean, use True is this is last (or only) operation
...
class PyCRYPTPROV(object):
      ...
      def CryptReleaseContext(self,Flags:'int'=0) -> 'None':
         """
...
Returns:
      ...
      def CryptGenKey(self,Algid:'int',Flags:'int',KeyLen:'int'=0) -> 'PyCRYPTKEY':
         """
         Generates a key pair or a session key

Args:

      Algid(int):Algorithm identifier, one of the CALG_* values, or AT_KEYEXCHANGE/AT_SIGNATURE
      Flags(int):Combination of CRYPT_CREATE_SALT,CRYPT_EXPORTABLE,CRYPT_NO_SALT,CRYPT_PREGEN,CRYPT_USER_PROTECTED,CRYPT_ARCHIVABLE
      KeyLen(int):Length of key to generate, can be 0 to use provider's default key lengthCommentsDiffers from Api call in that the length is passed in separately
...
Returns:
      ...
      def CryptGetProvParam(self,Param:'int',Flags:'int'=0) -> 'None':
         """
         Retrieves specified attribute of provider

Args:

      Param(int):One of the PP_* values
      Flags(int):If param if PP_KEYSET_SEC_DESCR, can be a combination of OWNER_SECURITY_INFORMATION,GROUP_SECURITY_INFORMATION,DACL_SECURITY_INFORMATION,SACL_SECURITY_INFORMATIONReturn ValueType of returned object is dependent on the attribute requested
...
Return ValueType of returned object is dependent on the attribute requested
      ...
      def CryptGetUserKey(self,KeySpec:'int') -> 'PyCRYPTKEY':
         """
         Returns a handle to one of user's key pairs

Args:

      KeySpec(int):AT_KEYEXCHANGE or AT_SIGNATURE (some providers may implement extra key specs)
...
Returns:
      ...
      def CryptGenRandom(self,Len:'int',SeedData:'str'=None) -> 'str':
         """
...
Returns:
      ...
      def CryptCreateHash(self,Algid:'int',Key:'PyCRYPTKEY'=None,Flags:'int'=0) -> 'PyCRYPTHASH':
         """
         Creates a hash object for hashing large amounts of data

Args:

      Algid(int):An algorithm identifier, CALG_*.
...
Returns:
      ...
      def CryptImportKey(self,Data:'Any',PubKey:'PyCRYPTKEY'=None,Flags:'int'=0) -> 'PyCRYPTKEY':
         """
         None
...
Args:
      ...
      Flags(int):Combination of CRYPT_EXPORTABLE, CRYPT_OAEP, CRYPT_NO_SALT, CRYPT_USER_PROTECTED
...
Returns:
      ...
      def CryptExportPublicKeyInfo(self,KeySpec:'int',CertEncodingType:'int') -> 'PyCERT_PUBLIC_KEY_INFO':
         """
...
Args:
      ...
      KeySpec(int):AT_KEYEXCHANGE or AT_SIGNATURE
      CertEncodingType(int):Specifies encoding for exported key info
...
Returns:
      ...
      def CryptImportPublicKeyInfo(self,Info:'dict',CertEncodingType:'int') -> 'PyCRYPTKEY':
         """
         Imports another user's public key

Args:

      Info(dict):PyCERT_PUBLIC_KEY_INFO dictionary as returned by PyCRYPTPROV::CryptExportPublicKeyInfo
      CertEncodingType(int):Specifies encoding for exported key info
...
class PyCRYPT_DECRYPT_MESSAGE_PARA(object):
      ...
      @property
      def MsgAndCertEncodingType(self)->'int':
...
Returns:
      ...
      def CertEnumCTLContextProperties(self,) -> 'Tuple[int, ...]':
         """
...
Returns:
      ...
      def CertEnumSubjectInSortedCTL(self,) -> 'Tuple[Tuple[str, str], ...]':
         """
...
Returns:
      ...
      Tuple[Tuple[str, str], ...]:PyCTL_CONTEXT.CertEnumSubjectInSortedCTL
...
Returns:
      ...
      def CertSerializeCTLStoreElement(self,Flags:'int'=0) -> 'str':
         """
...
if cursor is visible
      ...
      def SetConsoleCursorInfo(self,Size:'int',Visible:'Any') -> 'None':
         """
         Sets the size and visibility of console's cursor

Args:

      Size(int):Percentage of character size that cursor will occupy
...
Returns:
      ...
      int:PyConsoleScreenBuffer.GetConsoleMode
...
Return ValueReturns a combination of ENABLE_*_INPUT or ENABLE_*_OUTPUT constants
      ...
      def SetConsoleMode(self,Mode:'int') -> 'None':
         """
         Sets the input or output mode of the console buffer

Args:

      Mode(int):Combination of ENABLE_*_INPUT or ENABLE_*_OUTPUT constants
...
Returns:
      ...
      def ReadConsole(self,NumberOfCharsToRead:'int') -> 'Any':
         """
         Reads characters from the console input buffer

Args:

      NumberOfCharsToRead(int):Characters to read
...
Returns:
      ...
      def WriteConsole(self,Buffer:'Any') -> 'int':
         """
...
Returns:
      ...
      int:String or Unicode to be written to consoleReturn ValueReturns the number of characters written
...
Args:
      ...
      Attributes(int):Attributes to be set, combination of FOREGROUND_*, BACKGROUND_*, and COMMON_LVB_* constants
...
Returns:
      ...
      def GetConsoleScreenBufferInfo(self,) -> 'dict':
         """
...
Returns:
      ...
      def FillConsoleOutputAttribute(self,Attribute:'int',Length:'int',WriteCoord:'PyCOORD') -> 'int':
         """
...
Args:
      ...
      Attribute(int):Text attributes to be set, combination of FOREGROUND_*, BACKGROUND_*, and COMMON_LVB_* constants
      Length(int):The number of characters to set
...
Returns:
      ...
      int:The screen position to begin atReturn ValueReturns the number of character cells whose attributes were set
      ...
      def FillConsoleOutputCharacter(self,Character:'Any',Length:'int',WriteCoord:'PyCOORD') -> 'int':
         """
...
Args:
      ...
      Length(int):The number of characters positions to fill
      WriteCoord(PyCOORD):The screen position to begin atReturn ValueReturns the number of characters actually written

Returns:

      int:The screen position to begin atReturn ValueReturns the number of characters actually written
      ...
      def ReadConsoleOutputCharacter(self,Length:'int',ReadCoord:'PyCOORD') -> 'str':
         """
...
Args:
      ...
      Length(int):The number of characters positions to read
...
Returns:
      ...
      def ReadConsoleOutputAttribute(self,Length:'int',ReadCoord:'PyCOORD') -> 'Tuple[int, ...]':
         """
...
Args:
      ...
      Length(int):The number of attributes to read
...
Returns:
      ...
      Tuple[int, ...]:The screen position from which to start readingReturn ValueReturns a sequence of ints containing the attributes of a range of characters
      ...
      def WriteConsoleOutputCharacter(self,Characters:'Any',WriteCoord:'PyCOORD') -> 'int':
         """
...
Returns:
      ...
      int:The screen position at which to start writingReturn ValueReturns the number of characters actually written
      ...
      def WriteConsoleOutputAttribute(self,Attributes:'Tuple[int, ...]',WriteCoord:'PyCOORD') -> 'int':
         """
         Sets the attributes of a range of character cells

Args:

      Attributes(Tuple[int, ...]):A sequence of ints containing the attributes to be set
      WriteCoord(PyCOORD):The screen position at which to start writingReturn ValueReturns the number of attributes set

Returns:

      int:The screen position at which to start writingReturn ValueReturns the number of attributes set
      ...
      def ScrollConsoleScreenBuffer(self,ScrollRectangle:'PySMALL_RECT',ClipRectangle:'PySMALL_RECT',DestinationOrigin:'PyCOORD',FillCharacter:'Any',FillAttribute:'int') -> 'None':
         """
...
Args:
      ...
      FillAttribute(int):Text attributes to apply to FillCharacter
...
Returns:
      ...
      def GetCurrentConsoleFont(self,MaximumWindow:'Any'=False) -> 'Tuple[int, PyCOORD]':
         """
...
Returns:
      ...
      Tuple[int, PyCOORD]:If True, retrieves font size for maximum window size
Comments
...
Return ValueReturns the index of current font and window size
      ...
      def GetConsoleFontSize(self,Font:'int') -> 'PyCOORD':
         """
         Returns size of specified font for the console

Args:

      Font(int):Index of font as returned by GetCurrentConsoleFontCommentsOnly exists on XP or later.
...
Returns:
      ...
      def SetConsoleFont(self,Font:'int') -> 'None':
         """
         Changes the font used by the screen buffer

Args:

      Font(int):The number of the font to be setCommentsFunction is not documented on MSDN
...
Returns:
      ...
      def SetStdHandle(self,StdHandle:'int') -> 'None':
         """
         Replaces one of calling process's standard handles with this handle

Args:

      StdHandle(int):Specifies handle to be replaced - STD_INPUT_HANDLE, STD_OUTPUT_HANDLE, or STD_ERROR_HANDLE
...
Returns:
      ...
      def SetConsoleDisplayMode(self,Flags:'int',NewScreenBufferDimensions:'PyCOORD') -> 'None':
         """
         Sets the display mode of the console buffer

Args:

      Flags(int):CONSOLE_FULLSCREEN_MODE or CONSOLE_WINDOWED_MODE
...
Returns:
      ...
      def WriteConsoleInput(self,Buffer:'Tuple[PyINPUT_RECORD, ...]') -> 'int':
         """
...
Returns:
      ...
      int:A sequence of PyINPUT_RECORD objectsReturn ValueReturns the number of records written
      ...
      def ReadConsoleInput(self,Length:'int') -> 'Tuple[PyINPUT_RECORD, ...]':
         """
...
Args:
      ...
      Length(int):The number of input records to readCommentsThis functions blocks until at least one record is read. The number of records returned may be less than the nbr requestedReturn ValueReturns a sequence of PyINPUT_RECORD objects
...
Return ValueReturns a sequence of PyINPUT_RECORD objects
      ...
      def PeekConsoleInput(self,Length:'int') -> 'Tuple[PyINPUT_RECORD, ...]':
         """
...
Args:
      ...
      Length(int):The number of input records to readCommentsThis function does not block as ReadConsoleInput does. The number of records returned may be less than the nbr requestedReturn ValueReturns a sequence of PyINPUT_RECORD objects
...
Return ValueReturns a sequence of PyINPUT_RECORD objects
      ...
      def GetNumberOfConsoleInputEvents(self,) -> 'int':
         """
...
Returns:
      ...
      def MakeSignature(self,fqop:'int',Message:'PySecBufferDesc',MessageSeqNo:'int') -> 'None':
         """
...
Args:
      ...
      fqop(int):Flags that indicate quality of protection desired, specific to each security package
      Message(PySecBufferDesc):Buffer set that includes buffers for input data and output signature
      MessageSeqNo(int):A sequential number used by some packages to verify that no extraneous messages have been receivedCommentsThe buffer configuration is dependent on the security package.  Usually there is one input buffer of type SECBUFFER_DATA and an output buffer of type SECBUFFER_TOKENReturn ValueReturns None on success, and output buffer in Message will contain the signature
...
Return ValueReturns None on success, and output buffer in Message will contain the signature
      ...
      def VerifySignature(self,Message:'PySecBufferDesc',MessageSeqNo:'int') -> 'None':
         """
         None
...
Args:
      ...
      MessageSeqNo(int):A sequential number used by some packages to verify that no extraneous messages have been receivedCommentsThe buffer configuration is dependent on the security package.  Usually there is a data buffer of type SECBUFFER_DATA and a signature buffer of type SECBUFFER_TOKENReturn ValueReturns quality of protection flags used to create signature
...
Return ValueReturns quality of protection flags used to create signature
      ...
      def EncryptMessage(self,fqop:'int',Message:'PySecBufferDesc',MessageSeqNo:'int') -> 'None':
         """
...
Args:
      ...
      MessageSeqNo(int):A sequential number used by some packages to verify that no extraneous messages have been receivedCommentsThe buffer configuration is dependent on the security package.  Usually there is one input buffer of type SECBUFFER_DATA to be encrypted in-place and another empty buffer of type SECBUFFER_PADDING or SECBUFFER_TOKEN to receive signature or padding dataReturn ValueReturns None on success, and buffer(s) will contain encrypted data
...
Return ValueReturns None on success, and buffer(s) will contain encrypted data
      ...
      def DecryptMessage(self,Message:'PySecBufferDesc',MessageSeqNo:'int') -> 'None':
         """
         None
...
Args:
      ...
      MessageSeqNo(int):A sequential number used by some packages to verify that no extraneous messages have been receivedCommentsThe buffer configuration is dependent on the security package.  Usually there is one buffer of type SECBUFFER_DATA which is modified in place and a second buffer of type SECBUFFER_TOKEN or SECBUFFER_PADDING containing signature, padding, or other extra data from encryption process that doesn't fit in first bufferReturn ValueReturns flags specfic to security package indicating quality of protection
...
structure"""
      ...
      @property
      def stemmedSearch(self)->'int':
         """TRUE for StemmedSearch only."""
         pass


      @property
      def titleOnly(self)->'int':
...
class PyHH_WINTYPE(object):
      ...
      @property
      def validMembers(self)->'int':
         """Specifies which members in the structure are valid."""
         pass


      @property
      def winProperties(self)->'int':
...
Returns:
      ...
      def SetSecurityDescriptorOwner(self,sid:'PySID',bOwnerDefaulted:'int') -> 'None':
         """
         Set owner SID.
...
Args:
      ...
      bOwnerDefaulted(int):Normally set to false since this explicitely set the owner.
...
Returns:
      ...
      def SetSecurityDescriptorGroup(self,sid:'PySID',bOwnerDefaulted:'int') -> 'int':
         """
         Set group SID.
...
Returns:
      ...
      def SetSecurityDescriptorSacl(self,bSaclPresent:'int',SACL:'PyACL',bSaclDefaulted:'int') -> 'None':
         """
...
Args:
      ...
      bSaclPresent(int):A flag indicating if SACL is to be used. If false, last 2 parms are ignored.
      SACL(PyACL):The SACL to set in the security descriptor
      bSaclDefaulted(int):Flag, set to false if user has specifically set the SACL.
...
Returns:
      ...
      def SetSecurityDescriptorControl(self,ControlBitsOfInterest:'int',ControlBitsToSet:'int') -> 'None':
         """
...
Args:
      ...
      ControlBitsOfInterest(int):Bitmask of flags to be modified
      ControlBitsToSet(int):Bitmask containing flag values to setCommentsOnly exists on Windows 2000 or later
...
class PySERVER_INFO_402(object):
      ...
      @property
      def ulist_mtime(self)->'int':
         """"""
         pass


      @property
      def glist_mtime(self)->'int':
         """"""
         pass


      @property
      def alist_mtime(self)->'int':
         """"""
         pass
      ...
      @property
      def numadmin(self)->'int':
         """"""
         pass


      @property
      def lanmask(self)->'int':
         """"""
         pass
      ...
      @property
      def openfiles(self)->'int':
         """"""
         pass


      @property
      def sessopens(self)->'int':
         """"""
         pass


      @property
      def sessvcs(self)->'int':
         """"""
         pass


      @property
      def sessreqs(self)->'int':
         """"""
         pass


      @property
      def opensearch(self)->'int':
         """"""
         pass


      @property
      def activelocks(self)->'int':
         """"""
         pass


      @property
      def numreqbuf(self)->'int':
         """"""
         pass


      @property
      def sizreqbuf(self)->'int':
         """"""
         pass


      @property
      def numbigbuf(self)->'int':
         """"""
         pass


      @property
      def numfiletasks(self)->'int':
         """"""
         pass


      @property
      def alertsched(self)->'int':
         """"""
         pass


      @property
      def erroralert(self)->'int':
         """"""
         pass


      @property
      def logonalert(self)->'int':
         """"""
         pass


      @property
      def accessalert(self)->'int':
         """"""
         pass


      @property
      def diskalert(self)->'int':
         """"""
         pass


      @property
      def netioalert(self)->'int':
         """"""
         pass


      @property
      def maxauditsz(self)->'int':
         """"""
         pass
...
class PySERVER_INFO_403(object):
      ...
      @property
      def auditedevents(self)->'int':
         """"""
         pass


      @property
      def autoprofile(self)->'int':
         """"""
         pass
...
class PySERVER_INFO_502(object):
      ...
      @property
      def initworkitems(self)->'int':
         """"""
         pass


      @property
      def maxworkitems(self)->'int':
         """"""
         pass


      @property
      def rawworkitems(self)->'int':
         """"""
         pass


      @property
      def irpstacksize(self)->'int':
         """"""
         pass


      @property
      def maxrawbuflen(self)->'int':
         """"""
         pass


      @property
      def sessusers(self)->'int':
         """"""
         pass


      @property
      def sessconns(self)->'int':
         """"""
         pass


      @property
      def maxpagedmemoryusage(self)->'int':
         """"""
         pass


      @property
      def maxnonpagedmemoryusage(self)->'int':
         """"""
         pass


      @property
      def enableforcedlogoff(self)->'bool':
         """"""
         pass


      @property
      def timesource(self)->'bool':
         """"""
         pass


      @property
      def acceptdownlevelapis(self)->'bool':
         """"""
         pass


      @property
      def lmannounce(self)->'bool':
         """"""
         pass
...
class PySERVER_INFO_503(object):
      ...
      @property
      def maxkeepsearch(self)->'int':
         """"""
         pass


      @property
      def scavtimeout(self)->'int':
         """"""
         pass


      @property
      def minrcvqueue(self)->'int':
         """"""
         pass


      @property
      def minfreeworkitems(self)->'int':
         """"""
         pass


      @property
      def xactmemsize(self)->'int':
         """"""
         pass
      ...
      @property
      def maxmpxct(self)->'int':
         """"""
         pass


      @property
      def oplockbreakwait(self)->'int':
         """"""
         pass


      @property
      def oplockbreakresponsewait(self)->'int':
         """"""
         pass


      @property
      def enableoplocks(self)->'bool':
         """"""
         pass


      @property
      def enablefcbopens(self)->'bool':
         """"""
         pass


      @property
      def enableraw(self)->'bool':
         """"""
         pass


      @property
      def enablesharednetdrives(self)->'bool':
         """"""
         pass


      @property
      def minfreeconnections(self)->'int':
         """"""
         pass


      @property
      def maxfreeconnections(self)->'int':
         """"""
         pass
...
class PySID(object):
      ...
      def Initialize(self,idAuthority:'Any',numSubauthorities:'int') -> 'None':
         """
         Initialize the SID.
...
Args:
      ...
      numSubauthorities(int):The number of sub authorities to allocate.
...
Returns:
      ...
      def SetSubAuthority(self,index:'int',val:'int') -> 'None':
         """
         Sets a SID SubAuthority

Args:

      index(int):The index of the sub authority to set
      val(int):The value for the sub authorityCommentsSee the function SetSidSubAuthority
...
Returns:
      ...
      def GetSidIdentifierAuthority(self,) -> 'Tuple[int, int, int, int, int, int]':
         """
...
class PyUSER_INFO_11(object):
      ...
      @property
      def last_logon(self)->'int':
         """"""
         pass


      @property
      def last_logoff(self)->'int':
         """"""
         pass


      @property
      def bad_pw_count(self)->'int':
         """"""
         pass


      @property
      def num_logons(self)->'int':
         """"""
         pass
...
class PyUSER_MODALS_INFO_0(object):
      ...
      @property
      def min_passwd_len(self)->'int':
         """"""
         pass


      @property
      def max_passwd_age(self)->'int':
         """"""
         pass


      @property
      def min_passwd_age(self)->'int':
         """"""
         pass


      @property
      def force_logoff(self)->'int':
         """"""
         pass


      @property
      def password_hist_len(self)->'int':
         """"""
         pass
...
class PyUSER_MODALS_INFO_3(object):
      ...
      @property
      def lockout_observation_window(self)->'int':
         """"""
         pass


      @property
      def usrmod3_lockout_threshold(self)->'int':
         """"""
         pass
...
class PyWKSTA_INFO_302(object):
      ...
      @property
      def maximum_collection_count(self)->'int':
...
class PyWKSTA_INFO_502(object):
      ...
      @property
      def lock_quota(self)->'int':
         """TODO"""
         pass


      @property
      def lock_increment(self)->'int':
         """TODO"""
         pass


      @property
      def lock_maximum(self)->'int':
         """TODO"""
         pass


      @property
      def pipe_increment(self)->'int':
         """TODO"""
         pass


      @property
      def pipe_maximum(self)->'int':
         """TODO"""
         pass


      @property
      def cache_file_timeout(self)->'int':
         """TODO"""
         pass


      @property
      def dormant_file_limit(self)->'int':
         """TODO"""
         pass


      @property
      def read_ahead_throughput(self)->'int':
         """TODO"""
         pass


      @property
      def num_mailslot_buffers(self)->'int':
         """TODO"""
         pass


      @property
      def num_srv_announce_buffers(self)->'int':
         """TODO"""
         pass


      @property
      def max_illegal_datagram_events(self)->'int':
         """TODO"""
         pass


      @property
      def illegal_datagram_event_reset_frequency(self)->'int':
         """TODO"""
         pass


      @property
      def log_election_packets(self)->'bool':
         """TODO"""
         pass


      @property
      def use_opportunistic_locking(self)->'bool':
         """TODO"""
         pass


      @property
      def use_unlock_behind(self)->'bool':
         """TODO"""
         pass


      @property
      def use_close_behind(self)->'bool':
         """TODO"""
         pass


      @property
      def buf_named_pipes(self)->'bool':
         """TODO"""
         pass


      @property
      def use_lock_read_unlock(self)->'bool':
         """TODO"""
         pass


      @property
      def utilize_nt_caching(self)->'bool':
         """TODO"""
         pass


      @property
      def use_raw_read(self)->'bool':
         """TODO"""
         pass


      @property
      def use_raw_write(self)->'bool':
         """TODO"""
         pass


      @property
      def use_write_raw_data(self)->'bool':
         """TODO"""
         pass
      ...
      @property
      def buf_files_deny_write(self)->'bool':
         """TODO"""
         pass


      @property
      def buf_read_only_files(self)->'bool':
         """TODO"""
         pass


      @property
      def force_core_create_mode(self)->'bool':
         """TODO"""
         pass


      @property
      def use_512_byte_max_transfer(self)->'bool':
         """TODO"""
         pass
...
class PyWKSTA_TRANSPORT_INFO_0(object):
      ...
      @property
      def quality_of_service(self)->'int':
...
Args:
      ...
      needle(str):String to be located
      start(int):Pos at which to start search, current pos assumed if not specifiedReturn ValueReturns pos of string, or -1 if not found

Returns:

      int:Pos at which to start search, current pos assumed if not specifiedReturn ValueReturns pos of string, or -1 if not found
...
Args:
      ...
      offset(int):Position in buffer at which to flush
      size(int):Number of bytes to flush, 0 to flush remainder of buffer past the offset
...
Args:
      ...
      dest(int):Destination position in buffer
      src(int):Source position in buffer
      count(int):Number of bytes to move
...
Returns:
      ...
      def seek(self,dist:'int',how:'int'=0) -> 'None':
         """
         Changes current position

Args:

      dist(int):Distance to seek
      how(int):Pos from which to seekhowmeaning0Seek from start of buffer1Seek from current position2Seek backwards from end of buffer
...
Returns:
      ...
      def write_byte(self,char:'str') -> 'None':
         """
         Writes a single character of data

Args:

      char(str):Single byte to be placed in buffer
...
class SERVICE_FAILURE_ACTIONS(object):
      ...
      @property
      def RebootMsg(self)->'Union[str]':
         """Message displayed when reboot action is taken"""
         pass


      @property
      def Command(self)->'Union[str]':
...
class connection(object):
      ...
      def setautocommit(self,c:'int') -> 'None':
         """
         Sets the autocommit mode.

Args:

      c(int):The boolean autocommit mode.
...
Returns:
      ...
      def execute(self,sql:'str',var:'Any'=[]) -> 'int':
         """
         Execute some SQL
